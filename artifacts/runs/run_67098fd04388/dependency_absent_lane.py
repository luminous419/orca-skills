"""Dependency-absent lane for run_67098fd04388: a verbatim copy of the run_8288bf8f1d89
lane with the new OS-40 round 3 lease-keeper module added.  The original is read-only.
"""
import sys, unittest
...
MODULES = [
    ...
    "scripts.test_deterministic_workflow_lease_keeper",
